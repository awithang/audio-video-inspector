    ...
    <div className="relative bg-gradient-to-r from-forensic-DEFAULT to-forensic-secondary overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-24 md:py-32 flex flex-col md:flex-row items-center relative z-10">
        <div className="md:w-1/2 mb-12 md:mb-0 text-white">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight animate-fadeInUp text-forensic-light">
            Advanced Audio & Video Forensic Analysis
          </h1>
          <p className="text-lg md:text-xl mb-8 max-w-lg animate-fadeInUp animation-delay-200 text-forensic-light">
          ...
          <div className="relative w-full max-w-md bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 p-4 rounded-lg flex flex-col items-center text-center">
                ...
                <h3 className="text-forensic-light font-medium">Audio Analysis</h3>
                <p className="text-sm text-forensic-light mt-2">Forensic examination of audio files</p>
              </div>
              <div className="bg-white/10 p-4 rounded-lg flex flex-col items-center text-center">
                <FileVideo className="text-forensic-highlight mb-3 h-10 w-10" />
                <h3 className="text-forensic-light font-medium">Video Analysis</h3>
                <p className="text-sm text-forensic-light mt-2">Detailed video evidence examination</p>
              </div>
              <div className="bg-white/10 p-4 rounded-lg flex flex-col items-center text-center">
                <FileAudio className="text-forensic-highlight mb-3 h-10 w-10" />
                <h3 className="text-forensic-light font-medium">Authentication</h3>
                <p className="text-sm text-forensic-light mt-2">Verify media authenticity</p>
              </div>
              <div className="bg-white/10 p-4 rounded-lg flex flex-col items-center text-center">
                <svg
                  className="text-forensic-highlight mb-3 h-10 w-10"
                  viewBox="0 0 24 24"
                  fill="none"
                ...
                <h3 className="text-forensic-light font-medium">Enhancement</h3>
                <p className="text-sm text-forensic-light mt-2">Improve media quality for analysis</p>
              </div>
            </div>
          </div>
        </div>
