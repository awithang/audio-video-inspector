          ...
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
              <div className="bg-gray-50 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-100">
                ...
                <h2 className="text-2xl font-bold text-forensic-DEFAULT mb-4">Audio Forensics</h2>
              ...
              <div className="bg-gray-50 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-100">
                ...
                <h2 className="text-2xl font-bold text-forensic-DEFAULT mb-4">Video Forensics</h2>
                <p className="text-forensic-secondary mb-6">
              ...
              <div className="bg-gray-50 rounded-xl p-8 text-center hover:shadow-lg transition-all duration-300 border border-gray-100">
                ...
                <h2 className="text-2xl font-bold text-forensic-DEFAULT mb-4">Authentication</h2>
                <p className="text-forensic-secondary mb-6">
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-white rounded-xl overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-forensic-DEFAULT mb-2">Audio Analysis Suite</h3>
              ...
              <div className="bg-white rounded-xl overflow-hidden shadow-md">
                ...
                <div className="p-6">
                  <h3 className="text-xl font-bold text-forensic-DEFAULT mb-2">Video Processing Laboratory</h3>
                  <p className="text-forensic-secondary mb-4">
