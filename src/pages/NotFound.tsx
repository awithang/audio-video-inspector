        ...
        <div className="text-center px-4">
          <div className="mb-6 inline-block">
            <div className="relative">
              <div className="text-9xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-forensic-DEFAULT to-forensic-accent">404</div>
              <div className="absolute -top-4 -right-4 bg-forensic-accent text-white text-sm px-3 py-1 rounded-full">
                Page Not Found
              </div>
            </div>
          </div>
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-forensic-DEFAULT">Oops! This page doesn't exist</h1>
          <p className="text-lg text-forensic-secondary mb-8 max-w-md mx-auto">
